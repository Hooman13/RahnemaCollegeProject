...
export const ProfileSidebar: FunctionComponent = () => {
  ...
  return (
    <div className="h-[878px] 2xl:h-[1000px] w-[296px] 2xl:w-[400px] col-span-3 2xl:col-span-4 bg-white border-[#A5A5A5] rounded-t-[45px] border-[1px] justify-items-center	">
      <div>
        ...
        <div className="w-auto text-base 2xl:text-xl font-normal items-center py-4 flex h-auto pr-9 px-8 hover:bg-[#F2F2F7] border-none rounded-[75px] text-center">
          <Link to="/profile">
      ...
      <div className="w-auto text-base 2xl:text-xl font-normal mt-[250px] flex h-auto pr-9 px-8 hover:bg-[#F2F2F7] border-none rounded-[75px] text-center">
        <Link to="/search">
